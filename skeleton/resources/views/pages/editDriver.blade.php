...
<form class="text-black mw-50" method="post" action="{{route('driver.update', $driver->id)}}" >
    ...
    <label class="">Email:<input id="email" type="email" name="email" class="" value={{$driver->email}} required></label>
    <label class="">Driver License:<input id="drivers_license" type="text" name="drivers_license" class="" value={{$driver->drivers_license}} required></label>
