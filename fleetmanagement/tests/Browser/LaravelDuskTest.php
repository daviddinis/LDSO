    ...
    {        
        $this->browse(function (Browser $browser) {
            $browser->visit('http://ifleet.dusk.test/')
                    ...
                    ->value('#password', '1234')
                    ->click('.btn')
                    ->click('#carTable > tbody:nth-child(2) > tr:nth-child(2) > td:nth-child(1) > a:nth-child(1)')
    ...
    {        
        $this->browse(function (Browser $browser) {
            $browser->visit('http://ifleet.dusk.test/')
                    ...
                    ->value('#password', '1234')
                    ->click('.btn')
                    ->click('#carTable > tbody:nth-child(2) > tr:nth-child(9) > td:nth-child(1) > a:nth-child(1)')
                    ->click('div.col:nth-child(3) > a:nth-child(1)')
                    ->assertSee('Your tax has expired!')
                    ->click('.btn-primary')
                    ->keys('#date', '10102018')
                    ->keys('#expiration_date', '10102025')
                    ->value('#value', '139')
