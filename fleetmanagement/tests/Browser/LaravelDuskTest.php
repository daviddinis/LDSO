    ...
    {        
        $this->browse(function (Browser $browser) {
            $browser->visit('http://ifleet.dusk.test/')
                    ...
                    ->value('#password', '1234')
                    ->click('.btn')
                    ->click('.table > tbody:nth-child(2) > tr:nth-child(1) > th:nth-child(1) > a:nth-child(1)')
                    ->assertSee('Remove driver')
    ...
    {        
        $this->browse(function (Browser $browser) {
            $browser->visit('http://ifleet.dusk.test/')
                    ...
                    ->click('.btn')
                    ->click('.table > tbody:nth-child(2) > tr:nth-child(1) > th:nth-child(1) > a:nth-child(1)')
                    ->click('div.container:nth-child(3) > div:nth-child(4) > div:nth-child(1) > a:nth-child(1)')
                    ->click('.fa-plus')
                    ->keys('#date', '10102018')
    ...
    {        
        $this->browse(function (Browser $browser) {
            $browser->visit('http://ifleet.dusk.test/')
                    ...
                    ->click('.btn')
                    ->click('.table > tbody:nth-child(2) > tr:nth-child(1) > th:nth-child(1) > a:nth-child(1)')
                    ->click('div.container:nth-child(3) > div:nth-child(4) > div:nth-child(2) > a:nth-child(1)')
                    ->click('.fa-plus')
                    ->keys('#date', '10102018')
    ...
    {        
        $this->browse(function (Browser $browser) {
            $browser->visit('http://ifleet.dusk.test/')
                    ...
                    ->click('.btn')
                    ->click('.table > tbody:nth-child(2) > tr:nth-child(1) > th:nth-child(1) > a:nth-child(1)')
                    ->click('div.container:nth-child(3) > div:nth-child(4) > div:nth-child(3) > a:nth-child(1)')
                    ->click('.fa-plus')
                    ->keys('#date', '10102018')
                    ->keys('#expiration_date', '10102021')
                    ->value('#value', '139')
    ...
    {        
        $this->browse(function (Browser $browser) {
            $browser->visit('http://ifleet.dusk.test/')
                    ...
                    ->click('.btn')
                    ->click('.table > tbody:nth-child(2) > tr:nth-child(1) > th:nth-child(1) > a:nth-child(1)')
                    ->click('div.container:nth-child(3) > div:nth-child(4) > div:nth-child(4) > a:nth-child(1)')
                    ->click('.fa-plus')
                    ->keys('#date', '10102018')
                    ->keys('#expiration_date', '10102021')
                    ->value('#value', '139')
